      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <motion.div
            ...
            className="flex items-center gap-2 text-2xl font-extrabold text-blue-700 dark:text-yellow-400 tracking-tight drop-shadow-md select-none"
          >
            <motion.span
            ...
            >
              {/* Use a Lucide icon for the logo, e.g., Zap */}
              <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 text-blue-600 dark:text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
